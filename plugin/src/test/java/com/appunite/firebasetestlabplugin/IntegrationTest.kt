...
class IntegrationTest {
    ...
    fun `run firebaseTestLabSetup install gcloud`() {
        ...
        (project as ProjectInternal).evaluate()
        executeTask(project, "firebaseTestLabSetup")
    ...
    fun `ensure after evaluation tasks presented`() {
        ...
        project.getTasksByName("firebaseTestLabExecuteDebugInstrumentation", false).first()
        project.getTasksByName("firebaseTestLabExecuteDebugRobo", false).first()
    }
